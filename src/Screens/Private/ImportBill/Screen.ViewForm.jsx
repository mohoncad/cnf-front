...
const Screen = (props) => {
  ...
  const onPrint = (type) => {
    window.open(`report/${props.GlobalData.BillID}/${type}/import`);
  };
    ...
    <React.Fragment>
      <div style={{ padding: "10px", marginTop: "20px" }}>
        ...
        <Grid container spacing={2} className={classes.container}>
          ...
          <Grid item xs={10} className={classes.border}>
            <p>
              {props.GlobalData.BillInfo.Date !== null
                ? props.GlobalData.BillInfo.Date.format("DD/MM/YYYY")
                : ""}{" "}
            </p>
          </Grid>
          <Grid item xs={2} className={classes.border}>
          ...
          <Grid item xs={10} className={classes.border}>
            <p>
              {props.GlobalData.BillInfo.ClientBank &&
                props.GlobalData.BillInfo.ClientBank.Name}
            </p>
          </Grid>
          <Grid item xs={2} className={classes.border}>
            <p>Supplier</p>
          ...
          <Grid item xs={10} className={classes.border}>
            <p>
              {props.GlobalData.BillInfo.Supplier &&
                props.GlobalData.BillInfo.Supplier.Name}
            </p>
          </Grid>
          <Grid item xs={2} className={classes.border}>
            <p>Client</p>
          ...
          <Grid item xs={10} className={classes.border}>
            <p>
              {props.GlobalData.BillInfo.Client &&
                props.GlobalData.BillInfo.Client.Name}
            </p>
          </Grid>
          <Grid item xs={2} className={classes.border}>
            <p>Client Address</p>
        ...
        <Grid container spacing={2} className={classes.container}>
          ...
          <Grid item xs={10} className={classes.border}>
            <p>
              {props.GlobalData.JobDetails.currency_id &&
                props.GlobalData.JobDetails.currency_id.Name}
            </p>
          </Grid>
          <Grid item xs={2} className={classes.border}>
            <p>Currency Rate</p>
          ...
          <Grid item xs={10} className={classes.border}>
            <p>
              {" "}
              {props.GlobalData.JobDetails.unit_id &&
                props.GlobalData.JobDetails.unit_id.Name}
            </p>
          </Grid>
          <Grid item xs={2} className={classes.border}>
            <p>Quantity</p>
          ...
          <Grid item xs={10} className={classes.border}>
            <p>
              {" "}
              {props.GlobalData.JobDetails.port_id &&
                props.GlobalData.JobDetails.port_id.Name}
            </p>
          </Grid>
          <Grid item xs={2} className={classes.border}>
            <p>Commodity</p>
