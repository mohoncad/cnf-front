...
function Screen(props) {
  ...
  const [BypassSelectedId, setBypassSelectedId] = React.useState(
    props.BypassSelectedId
  );
  ...
  React.useEffect(() => {
    setBypassSelectedId(props.BypassSelectedId);
  }, [props.BypassSelectedId]);
        ...
        <TableContainer onContextMenu={(e) => e.preventDefault()}>
                  ...
                  return (
                    <TableRow
                      ...
                      onDoubleClick={() => {
                        if (!props.TrashMode) {
                          if (ViewPermission) {
                            props.onViewAction(row.id, row.Name, row.PortCode);
                          }
                        }
                      }}
                      onClick={(e) => {
          ...
          >
            {!props.TrashMode && (
              <div>
                {props.BypassMode && (
                  <MenuItem onClick={ContextMenuAction.bypassIdSelect}>
                    {BypassSelectedId === ContextMenuActionObject.id
                      ? "Unselect"
                      : "Select"}
                  </MenuItem>
                )}
