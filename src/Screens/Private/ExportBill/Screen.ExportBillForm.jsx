...
class Screen extends Component {
    ...
    axios
      ...
      .then((response) => {
        if (response.data.success) {
          batch(() => {
            let $billDetail = response.data.Export;
          ...
          this.props.func.HandleClient(
            ...
            //   this.props.func.HandleRegistration($billDetail.regist   )
  ...
  handleSubmitForm() {
    ...
    formData.append("bill_type", "Export");
    formData.append(
      "bill_date",
    ...
    axios
      .post(APP.ENV.URL.API.ROOT + "/company/export/save", formData, {
        headers: {
          Authorization: `Bearer ${Auth.getToken()}`,
