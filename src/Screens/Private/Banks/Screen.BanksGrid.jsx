...
const headCells = [
    ...
    // {id: 'Code', align: 'left', disablePadding: false, TrashModeOnly: false, label: 'Code'},
    {id: 'Name', align: 'left', disablePadding: false, TrashModeOnly: false, label: 'Name'},
    {id: 'BranchName', align: 'left', disablePadding: false, TrashModeOnly: false, label: 'Branch Name'},
    {id: 'AccountType', align: 'left', disablePadding: false, TrashModeOnly: false, label: 'Account Type'},
    {id: 'AccountName', align: 'center', disablePadding: false, TrashModeOnly: false, label: 'Account Name'},
    {id: 'AccountNumber', align: 'center', disablePadding: false, TrashModeOnly: false, label: 'Account Number'},
...
function Screen(props) {
    ...
    const Permissions = new APP.SERVICES.UAP().GetModulePermissions(APP.CONFIG.MODULE[5]);
                            ...
                            {stableSort(data, getComparator(order, orderBy)).map((row, index) => {
                                return (
                                    <TableRow key={row.id} hover
                                              title={props.BypassMode ? "Ctrl + click to select this bank" : "Double click to view"}
                                              onContextMenu={(e) => handleOpenContextMenu(e, {
                                                  view: () => {
                                                      row.title = row.Name;
                                                      props.onViewAction(row.id, row.Name, row.BranchName, row.AccountType, row.AccountName, row.AccountNumber);
                                                      handleCloseContextMenu();
                                                  },
                                                  edit: () => {
                                                      props.onEditAction(row.id, row.Name, row.BranchName, row.AccountType, row.AccountName, row.AccountNumber);
                                                      handleCloseContextMenu();
                                                  },
                                                  delete: () => {
                                                ...
                                                <React.Fragment>
                                                    { ViewPermission && (
                                                        ...
                                                        <IconButton
                                                            ...
                                                            onClick={() => props.onViewAction(row.id, row.Name, row.BranchName, row.AccountType, row.AccountName, row.AccountNumber)}>
                                                    ...
                                                    <Tooltip title={"Edit"} placement={"top"} enterDelay={500}>
                                                        <IconButton
                                                            ...
                                                            onClick={() => props.onEditAction(row.id, row.Name, row.BranchName, row.AccountType, row.AccountName, row.AccountNumber)}>
